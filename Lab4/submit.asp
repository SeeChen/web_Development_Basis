...
<html>
	...
	<body>
		...
		if err<>0 then
  			Response.Write("<p style='color:#1aa260;font-family:impact;font-size:2em;margin:1em;'>No update permissions!</p>")
		else 
  			Response.Write("<p style='color:#1aa260;font-family:impact;font-size:2em;margin:1em;'>" & recaffected & " record added</p>")
		end if
		conn.close
		%>
		<%
